...
class Database : public CImplement<IDatabase>
{
	public:
		...
		virtual int DLLCALLCONV readData(eDataSourceType type, const char* source = 0, void (DLLCALLCONV *progressCallBack)(void*, int, int) = 0, void *arg = 0, const char *location = 0, const char* options = 0);
		virtual int DLLCALLCONV writeData(eDataSourceType type, const char* source = 0, void (DLLCALLCONV *progressCallBack)(void*, int, int) = 0, void *arg = 0, const char *location = 0, const char* options = 0);
