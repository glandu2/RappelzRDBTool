...
static FieldDescriptor df[] =
	{{1, TYPE_INT32, "id"},
	 ...
	 {1, TYPE_FLOAT32, "casting_range"},   //decimal in DB
	 {1, TYPE_FLOAT32, "target_fx_size"},   //decimal in DB
	 ...
	 {MAKEINDEXEDVAR(8, 1), TYPE_DECIMAL, "drop_item_ratio_00"},
	 ...
	 {MAKEINDEXEDVAR(8, 1), TYPE_DECIMAL, "drop_item_ratio_01"},
	 ...
	 {1, TYPE_INT16, "worldmap_check_type"}};
